...
* The original package name 'com.example.jpa-hibernate-buildup1' is invalid and this project uses 'com.example.jpahibernatebuildup1' instead.
...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/docs/3.1.7/reference/htmlsingle/index.html#data.sql.jdbc)
